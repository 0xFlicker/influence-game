        ...
        <div className="space-y-1">
          {sorted.map(([name, count]) => {
            ...
            return (
              ...
              >
                {player && <GamePlayerAvatarPreview player={player} size="6" />}
          ...
          {Array.from(juryCounts.entries()).map(([name, count]) => {
            ...
            return (
              <div key={name} className="text-center">
                {player && <div className="mb-1 flex justify-center"><GamePlayerAvatarPreview player={player} size="10" /></div>}
    ...
    return (
      <div className="text-center animate-[fadeIn_0.3s_ease-out]">
        ...
        <div className="flex items-center justify-center gap-3 mb-6">
          {voterPlayer && <GamePlayerAvatarPreview player={voterPlayer} size="10" />}
        ...
        <div className="bg-white/[0.04] border border-white/[0.08] rounded-2xl px-8 py-6 inline-block max-w-md">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              {empowerPlayer && <GamePlayerAvatarPreview player={empowerPlayer} size="6" />}
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-xl">⚡</span>
              {exposePlayer && <GamePlayerAvatarPreview player={exposePlayer} size="6" />}
      ...
      <div className="text-center animate-[fadeIn_0.3s_ease-out]">
        ...
        <div className="bg-yellow-900/10 border border-yellow-500/15 rounded-2xl px-8 py-6 inline-block">
          ...
          <div className="flex items-center justify-center gap-3">
            <span className="text-xl">👑</span>
            {empowerPlayer && <GamePlayerAvatarPreview player={empowerPlayer} size="10" />}
    ...
    return (
      <div className="text-center animate-[fadeIn_0.3s_ease-out]">
        ...
        <div className="bg-red-900/10 border border-red-500/15 rounded-2xl px-8 py-6 inline-block">
          ...
          <div className="flex items-center justify-center gap-3">
            {targetPlayer && <GamePlayerAvatarPreview player={targetPlayer} size="10" />}
  ...
  if (juryVote) {
    ...
    return (
      <div className="text-center animate-[fadeIn_0.3s_ease-out]">
        ...
        <div className="flex items-center justify-center gap-3 mb-6">
          {jurorPlayer && <GamePlayerAvatarPreview player={jurorPlayer} size="10" />}
    ...
    return (
      <div className="text-center animate-[fadeIn_0.3s_ease-out]">
        ...
        <div className="flex items-center justify-center gap-3 mb-6">
          ...
          {agentPlayer && <GamePlayerAvatarPreview player={agentPlayer} size="10" />}
      ...
      <div className="text-center animate-[fadeIn_0.5s_ease-out]">
        ...
        <div className="flex items-center justify-center gap-4 flex-wrap mb-4">
          {tied.names.map((name) => {
            ...
            return (
              <div key={name} className="text-center">
                {p && <div className="mb-1 flex justify-center"><GamePlayerAvatarPreview player={p} size="10" /></div>}
    ...
    return (
      <div className="text-center animate-[fadeIn_0.5s_ease-out]">
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          {resolvedPlayer && <GamePlayerAvatarPreview player={resolvedPlayer} size="12" />}
        </div>
      ...
      <div className="text-center animate-[fadeIn_0.5s_ease-out]">
        ...
        <div className="relative inline-block mb-4">
          ...
          <div className="relative flex items-center justify-center gap-4">
            ...
            {wheelPlayer && <GamePlayerAvatarPreview player={wheelPlayer} size="12" />}
          </div>
        </div>
  ...
  if (empowered) {
    ...
    return (
      <div className="text-center animate-[fadeIn_0.5s_ease-out]">
        ...
        <div className="flex items-center justify-center gap-4">
          <span className="text-4xl">👑</span>
          {empPlayer && <GamePlayerAvatarPreview player={empPlayer} size="16" />}
        </div>
    ...
    return (
      <div className="text-center animate-[fadeIn_0.5s_ease-out]">
        ...
        <div className="flex items-center justify-center gap-4 mb-4">
          {winPlayer && <GamePlayerAvatarPreview player={winPlayer} size="16" />}
        </div>
      ...
      <div className="text-center animate-[fadeIn_0.3s_ease-out]">
        ...
        <div className="flex items-center justify-center gap-6 mb-8">
          <div className="text-center">
            {fromPlayer && <div className="mb-1 flex justify-center"><GamePlayerAvatarPreview player={fromPlayer} size="10" /></div>}
          ...
          <div className="text-center">
            {finalistPlayer && <div className="mb-1 flex justify-center"><GamePlayerAvatarPreview player={finalistPlayer} size="10" /></div>}
    ...
    return (
      <div className="text-center animate-[fadeIn_0.3s_ease-out]">
        <div className="flex items-center justify-center gap-3 mb-8">
          {fromPlayer && <GamePlayerAvatarPreview player={fromPlayer} size="12" />}
