...
describe("match-narrative-canonical-actions", () => {
  ...
  test("indexes every accepted-action registry event with event-specific actor extraction", () => {
    ...
    const specs: Array<{
      ...
      { eventType: "format.two_names_setup", sourceAction: "format-two-names-initial-names", cognitionAction: "format-two-names-initial-names", payload: { empoweredId: actorId } },
      { eventType: "format.two_names_override_declined", sourceAction: "format-two-names-override", cognitionAction: "format-two-names-override", payload: { overrideHolderId: actorId } },
      { eventType: "format.two_names_override_used", sourceAction: "format-two-names-override", cognitionAction: "format-two-names-override", payload: { overrideHolderId: actorId } },
      { eventType: "format.two_names_replacement_named", sourceAction: "format-two-names-replacement", cognitionAction: "format-two-names-replacement", payload: { empoweredId: actorId } },
      { eventType: "format.two_names_plea_recorded", sourceAction: "format-two-names-plea", cognitionAction: "format-two-names-plea", payload: { speakerId: actorId } },
