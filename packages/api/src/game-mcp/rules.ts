...
const RULE_SECTIONS: GameMcpRulesSection[] = [
  ...
  },
  {
    ...
    body: "Each standard pre-endgame round moves through Lobby; Mingle I and named-alliance formation; scarce pre-format alliance huddles; the empower-only vote; a two-format menu; the empowered player's format pick; format-aware Mingle under the locked rules; and format resolution with one elimination. There is no expose ballot on the standard path. The standard path has no separate Power / Protect / Pass or Council phase.",
  },
  {
    id: "named-alliances",
