...
CREATE INDEX IF NOT EXISTS "games_status_ended_created_idx"
		ON "games" USING btree ("status", "ended_at", "created_at");
...
CREATE INDEX IF NOT EXISTS "agent_profiles_name_id_idx"
		ON "agent_profiles" USING btree ("name", "id");
...
CREATE INDEX IF NOT EXISTS "game_players_agent_profile_game_id_idx"
		ON "game_players" USING btree ("agent_profile_id", "game_id");

CREATE INDEX IF NOT EXISTS "game_players_user_game_id_idx"
		ON "game_players" USING btree ("user_id", "game_id");
