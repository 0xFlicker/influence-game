...
- Provider-free baseline: 1,696 passed, 5 skipped. The sandbox blocked two loopback-server tests; rerunning with local network access passed.
- PostgreSQL baseline: 1,577 passed. Includes durable render/localization reuse, uncertain attempts, retry fencing, scene acceptance and stale-result checks with mocked providers.
- Workspace typechecks and lint passed. Additional focused agent tests cover room-audience rejection and diary image omission.
