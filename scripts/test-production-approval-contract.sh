...
require "$workflow" 'permission-administration: read' "branch-policy read permission is missing"
...
require "$controller" 'bypass_pull_request_allowances.users' "user PR-bypass allowances are not rejected"
require "$controller" 'bypass_pull_request_allowances.teams' "team PR-bypass allowances are not rejected"
require "$controller" 'bypass_pull_request_allowances.apps' "App PR-bypass allowances are not rejected"
